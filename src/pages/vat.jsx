...
const Vat = (props) => {
    ...
    useEffect(() => {
      const information = JsonData.Service.find(({title}) => (title === "Vat Registration and Returns") )
      SetData(information)
    }, [])
  return (
      <Structure data={data}/>
...
<div class="container row service-content">
...
<div className="col-md-6">
<img src="img/vat.jpg" className="service-img"/>
</div>
</div>
</>
)
